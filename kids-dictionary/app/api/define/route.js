...
Use simple, friendly language. Make examples relevant to a child's life. If the word doesn't exist, set definition to "Hmm, we couldn't find that word! Try checking the spelling." Respond with ONLY the JSON object, no extra text.`;
